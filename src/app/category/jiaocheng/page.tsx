...
export default function TutorialCategoryPage() {
  const filteredArticles = articles.filter(
    (article) => article.category === "教程" || article.category === "使用教程"
  );
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold mb-2 text-gray-800 dark:text-white">使用教程</h1>
          <p className="text-gray-600 dark:text-gray-400">OpenClaw 使用教程与最佳实践</p>
