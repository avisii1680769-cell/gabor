    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="mb-8 text-center">
          ...
          <h1 className="text-3xl font-bold mb-2 text-gray-800 dark:text-white">新闻</h1>
          <p className="text-gray-600 dark:text-gray-400">OpenClaw 最新新闻与公告</p>
